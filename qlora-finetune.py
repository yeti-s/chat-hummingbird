...
def train(
    ...
    prompt_template: str = "./prompt/alpaca.json",
    data_path: str = "./data/default.jsonl",
    output_dir: str = "./data/qlora_default",
    ...
    def tokenize(prompt, add_eos_token=True):
        ...
        if (
            ...
            and len(result["input_ids"]) < max_tokens
            and add_eos_token
        ):
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        for key in data_point.keys():
            inputs[key] = data_point[key]
        if 'answer' in inputs.keys():
            label = inputs['answer']
            del inputs["answer"]
        
        full_prompt = prompter.generate_prompt(inputs, label)
    ...
    prompter = Prompter(os.path.join('prompt', prompt_template))
